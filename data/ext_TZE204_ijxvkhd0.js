...
module.exports = [{
	...
	model: 'ZM-M100-24G',
	vendor: 'Wenzhi',
	description: 'Sensor de presencia humana 24G v1',
	fromZigbee: [fzLocal],
	toZigbee: [tzLocal],
	...
	exposes: [
		...
		exposes.numeric('move_sensitivity', ea.STATE_SET).withValueMin(1).withValueMax(10).withValueStep(1).withDescription('Sensibilidad de movimiento'),
		...
		exposes.numeric('radar_range', ea.STATE_SET).withValueMin(1.5).withValueMax(5.5).withValueStep(1).withUnit('m').withDescription('Distancia'),
		exposes.numeric('presence_timeout', ea.STATE_SET).withValueMin(1).withValueMax(1500).withValueStep(1).withUnit('s').withDescription('Demora'),
	],
	meta: {
		multiEndpoint: true,
		tuyaDatapoints: [
